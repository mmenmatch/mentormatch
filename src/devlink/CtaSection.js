...
export function CtaSection({ as: _Component = Block }) {
  return (
    <_Component
          ...
          <Block className={_utils.cx(_styles, "contact-card-2")} tag="div">
            <Grid className={_utils.cx(_styles, "contact-grid")} tag="div">
              <Block
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-a6006910-d9dc-5ac2-ee7f-ce5eec204942-363e5644"
                )}
                tag="div"
              >
                <Block
              ...
              <FormWrapper
                className={_utils.cx(
                  ...
                  "w-node-a6006910-d9dc-5ac2-ee7f-ce5eec204951-363e5644"
                )}
                  ...
                  >
                    <Grid className={_utils.cx(_styles, "form-grid")} tag="div">
                      ...
                      <Block
                        ...
                        id={_utils.cx(
                          _styles,
                          "w-node-a6006910-d9dc-5ac2-ee7f-ce5eec20495d-363e5644"
                        )}
                        tag="div"
                      >
                        <FormBlockLabel
