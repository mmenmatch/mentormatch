...
export function HomeWidget({
  ...
  return (
    <_Component className={_utils.cx(_styles, 'call-wrapper')} tag="div">
      <Block
        className={_utils.cx(_styles, 'call-modal', 'home-widget')}
        tag="div"
      >
      ...
      <Block
        className={_utils.cx(_styles, 'call-bubble', 'home-widget')}
        data-w-id="cc60e319-8a8d-1aa8-19f2-a96bfee7d812"
