...
export function LpInlineShortForm2Lines({ as: _Component = Block }) {
  return (
    <_Component
    ...
    >
      <FormWrapper className={_utils.cx(_styles, "form-block-7")}>
        <FormForm
          ...
          data-name="LP USA - popup"
          data-redirect="/successpage-us"
          id={_utils.cx(_styles, "wf-form-LP-USA---popup-2")}
          method="get"
          name="wf-form-LP-USA---popup-2"
          redirect="/successpage-us"
        >
          <Block
