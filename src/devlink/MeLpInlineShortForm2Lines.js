...
export function MeLpInlineShortForm2Lines({ as: _Component = Block }) {
  return (
    <_Component
    ...
    >
      <FormWrapper className={_utils.cx(_styles, 'form-block-7')}>
        <FormForm
          ...
          data-name="LP UAE - popup"
          data-redirect="/successpage-uae"
          id={_utils.cx(_styles, 'wf-form-LP-UAE---popup')}
          method="get"
          name="wf-form-LP-UAE---popup"
          redirect="/successpage-uae"
        >
          <Block
