...
export function LfLpUsa({ as: _Component = Section }) {
  return (
    <_Component
      ...
      <Block className={_utils.cx(_styles, 'container-regular-11')} tag="div">
        <Grid className={_utils.cx(_styles, 'grid-two-column-3')} tag="div">
          <Block
            ...
            id={_utils.cx(
              _styles,
              'w-node-_20fc40a1-e238-cfda-6f86-d89365cb7820-65cb781d'
            )}
            tag="div"
          >
            <FormWrapper className={_utils.cx(_styles, 'form_block---fl')}>
              ...
              >
                ...
                >
                  <Block
                    className={_utils.cx(_styles, 'text-block-130')}
                    tag="div"
                  >
                ...
                <Block className={_utils.cx(_styles, 'step_2')} tag="div">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {
                          'Are you comfortable with a price range of $30–$50 per session?'
                        }
                      </FormBlockLabel>
                      <FormSelect
                        className={_utils.cx(_styles, 'field_input-qdropd')}
