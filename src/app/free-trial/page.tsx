...
const freeTrialPage = () => {
  return (
    <div className="w-full flex flex-col">
      <NavBar width={'220'} whatsapp />
      <div className="w-full min-h-[calc(100vh-80px)] bg-[linear-gradient(90deg,#006CFF_62%,#049FF3_100%)] flex flex-col md:pb-0 pb-8  justify-center md:gap-16 gap-12 relative">
        <div className="w-full flex md:flex-row flex-col justify-center items-end px-4 md:gap-20 gap-4 ">
          ...
          <div className="free-trial-form-section md:py-8   md:w-[50%] w-full flex flex-col  gap-8 justify-center items-center">
            <FreeTrialForm />
            <Image src={RatingsBadge} alt={'mentor match'} width={300} />
            <p className="text-white md:text-[1rem] text-[4vw] font-semibold">
        ...
        {/* <div className="w-full flex flex-col gap-4 justify-center items-center  relative bottom-5">
          {/* <Image src={RatingsBadge} alt={'mentor match'} width={300} /> */}
        {/* <p className="text-white text-[1rem]">© 2026 Mentor Match. All rights reserved.</p> */}
        {/* </div> */}
      </div>
    </div>
  )
