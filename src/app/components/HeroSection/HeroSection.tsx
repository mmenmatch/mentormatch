      ...
      <div className='hero-content 2xl:w-[50%] w-full flex justify-center'>
        <div className='w-full flex flex-col xl:gap-8 gap-4  justify-center'>
          <div className='flex  xl:justify-start justify-center items-center'>
            <Tag title="Tutoring for every Grade and Curriculum" icon={ HeroContentImage } />
          </div>
          <p className={ `${myFont.className} xl:text-6xl text-2xl leading-[120%] xl:text-left text-center` }>
          ...
          <div className='flex xl:justify-start justify-center items-center gap-2 mb-2'>
            ...
            <p className={ `${myFont.className} xl:text-[1rem] text-[0.85rem] leading-[120%]` }>2.2K+ Students Worldwide</p>
          </div>
          <div className='w-full flex xl:justify-start justify-center items-center'>
            <button className='xl:px-6 xl:py-3 px-6 py-2 border-2 border-black rounded-4xl font-extrabold bg-[#fff116] '>Book A Free Trial</button>
          </div>
        </div>
      </div>
